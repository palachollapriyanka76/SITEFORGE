  ...
  const handleAnswerSubmit = async (answerText, updatedData) => {
    ...
    try {
      ...
      const fallbacks = {
        ...
        type: "Category saved. Generating consultant recommendations...",
        products: "Excellent product selection. Added to preview.",
        services: "Complementary services confirmed and saved.",
        categories: "Catalog navigation categories locked in.",
