...
import { verifyClerkToken, AuthenticatedRequest } from "../middleware/auth.middleware.js";
...
// =========================================================================
router.post("/sync-user", verifyClerkToken, async (req: AuthenticatedRequest, res: Response) => {
...
// =========================================================================
router.get("/me", verifyClerkToken, async (req: AuthenticatedRequest, res: Response) => {
  const clerkId = req.user?.clerkId;
