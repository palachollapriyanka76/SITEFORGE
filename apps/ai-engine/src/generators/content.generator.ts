export const generateSEOContent = async (businessData: any): Promise<{ metaTitle: string, metaDescription: string, keywords: string[] }> => {
...
export const generateTestimonials = async (businessType: string) => {
...
export const generateFAQ = async (businessType: string) => {
