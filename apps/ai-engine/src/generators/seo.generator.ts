 ...
 */
export function generateSitemap(websiteJSON: WebsiteJSON, baseUrl: string): string {
 ...
 */
export function generateStructuredData(websiteJSON: WebsiteJSON, baseUrl: string) {
  ...
  if (meta.favicon) {
    (schema as any)["logo"] = meta.favicon;
  }
