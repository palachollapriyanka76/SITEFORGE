...
export function getProductSearchQuery(name, industry) {
    ...
    if (ind.includes("restaurant") || ind.includes("cafe") || ind.includes("food") || ind.includes("dine")) {
        if (n.includes("chef") || n.includes("cook"))
            return "professional chef";
        if (n.includes("interior") || n.includes("dining") || n.includes("room") || n.includes("table"))
    ...
    if (ind.includes("salon") || ind.includes("spa") || ind.includes("hair") || ind.includes("beauty")) {
        ...
        if (n.includes("spa") || n.includes("massage"))
            return "spa luxury";
        if (n.includes("makeup") || n.includes("beauty") || n.includes("facial") || n.includes("treatment"))
            return "beauty treatment";
    ...
    if (ind.includes("elect") || ind.includes("phone") || ind.includes("gadg") || ind.includes("hardware")) {
        ...
        if (n.includes("laptop") || n.includes("computer") || n.includes("pc"))
            return "modern laptop";
        if (n.includes("headphone") || n.includes("headphones") || n.includes("earphone") || n.includes("audio"))
    ...
    if (ind.includes("fashion") || ind.includes("cloth") || ind.includes("boutique") || ind.includes("wear")) {
        if (n.includes("luxury") || n.includes("designer") || n.includes("premium"))
            return "designer clothing";
        return "fashion boutique"; // Default fashion
    }
    // Gym
    if (ind.includes("gym") || ind.includes("fit")) {
        if (n.includes("trainer") || n.includes("coach") || n.includes("instructor"))
            return "fitness trainer";
        if (n.includes("equipment") || n.includes("dumbbell") || n.includes("barbell") || n.includes("weight"))
    ...
    if (n.includes("spa"))
        return "spa luxury";
    if (n.includes("beauty") || n.includes("facial"))
        return "beauty treatment";
    if (n.includes("keyboard"))
        return "mechanical keyboard";
